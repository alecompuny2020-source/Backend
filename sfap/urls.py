...
router.register(r'transport-movements', v.TransportMovementViewSet, basename = 'transport')
router.register(r'crop-productions', v.CropProductionViewSet, basename='crop-production')
router.register(r'farm-ingredients', v.FeedIngredientStockViewSet, basename='ingredients')
