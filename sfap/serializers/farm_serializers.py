...
class FarmSerializers(BaseEnterpriseAuditSerializer):
    class Meta:
        model = Farm
        fields = [
            'id', 'name', 'manager', 'site_config', 'is_quarantined', 'region', 'district',
            'ward', 'postcode', 'address_metadata', 'full_address', 'is_active', 'created_by',
...
class FarmManagerHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'farm', 'plant', 'manager', 'start_date', 'end_date', 'tenure_metadata',
            'is_current'
        ]
...
class FarmBatchSerializer(BaseEnterpriseAuditSerializer):
    class Meta:
        model = Batch
        fields = [
            'id', 'batch_id', 'shed', 'bird_type', 'initial_count', 'current_count',
            'expected_depletion_date', 'batch_details', 'status',
            'age_in_days', 'created_by', 'updated_by', 'created_on', 'updated_on'
        ]
...
class DailyObservationSerializer(BaseEnterpriseAuditSerializer):
    class Meta:
        ...
        fields = [
            'id', 'batch', 'mortality_count', 'culls', 'environmental_data',
...
class BreederFlockSerializer(BaseEnterpriseAuditSerializer):
    class Meta:
        model = BreederFlock
        fields = [
            'id', 'source_batch', 'breed_line', 'genetic_source', 'traits',
            'lifetime_hatchability', 'created_by', 'updated_by', 'created_on',
            'updated_on'
        ]
