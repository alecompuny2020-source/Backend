...
from core.models import User, UserAddress, UserPreference
...
class UserPersonalInfoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["first_name", "middle_name", "last_name", "full_name", "date_joined"]
...
class UserProfileDetailSerializer(serializers.ModelSerializer):
    ...
    addresses = UserAddressSerializer(
        many=True, read_only=True, source="useraddress_set"
    )
