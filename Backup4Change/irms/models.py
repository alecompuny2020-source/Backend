...
class JobApplication(models.Model):
    ...
    status = models.CharField(
        max_length=12, choices=APPLICATION_STATUS, default="APPLIED"
    )
...
class Interview(models.Model):
    ...
    interview_type = models.CharField(
        max_length=10, choices=INTERVIEW_TYPE, default="VIDEO"
    )
    ...
    recruitment_manager_notes = models.TextField(
        _("Post-Interview Feedback"), blank=True
    )
