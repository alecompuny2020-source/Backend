...
class FarmSerializer(AuditFieldsMixin):
    farm_manager = serializers.CharField(
...
class BaseEnterpriseViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": self.get_success_message("create"), "data": response.data},
...
class CustomFarmPermissions(EnterpriseObjectPermission):
    ...
    perms_map = {
        ...
        "PUT": ["%(app_label)s.change_%(model_name)s", "farm.approve_batch_movement"],
